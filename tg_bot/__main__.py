...
TECHNO_IMG = "https://telegra.ph/Ano-Group-Manager-03-01-2"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Unknown_Helper_O02")],
                                                                                   [InlineKeyboardButton(text="ADD Ano Group Manager TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Main Group",
                                                                       url="https://t.me/GraphicCommunity4")
                                                                                 ]]))
